...
class SchedulerOutput:
    ...
    # TAPER+ online latency calibration metadata. These fields are populated by
    # the scheduler and read back when model execution for this step completes.
    taper_plus_step_start_s: float = 0.0
    taper_plus_decode_width: int = 0
    taper_plus_context_tokens: int = 0
    taper_plus_prefill_tokens: int = 0
    taper_plus_predicted_step_ms: float = 0.0
